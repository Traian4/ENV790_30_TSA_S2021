...
ggplot(BR_complete, aes(x=BR_complete[,1], y=BR_complete[,2])) +
...
time_seriesR <- ts(BR_complete[,2], frequency = 12, start = c(1901,1))
#It is a monthly data so the frequency is 12, while the first point is January 1901
head(time_seriesR)

time_seriesT <- ts(BR_complete[,3], frequency = 12, start = c(1901,1))
#It is a monthly data so the frequency is 12, while the first point is January 1901
head(time_seriesT)
